...
func SendEmailInvite(cfg config.EmailConfig, invite EmailInvite) error {
	h := hermes.Hermes{
		Product: hermes.Product{
			Name: "Taskscafe",
			Link: cfg.SiteURL,
			Logo: "https://matcornic.github.io/img/logo.png",
		},
	}
	...
	email := hermes.Email{
		Body: hermes.Body{
			...
			Intros: []string{
				"You have been invited to join WeManageIt",
			},
			Actions: []hermes.Action{
				{
					Instructions: "To get started with WeManageIt, please click here:",
	...
	// Set E-Mail subject
	m.SetHeader("Subject", "You have been invited to WeManageIt")
